...
| 3 | **Postgres provider trap:** Neon's ~190 free compute-hours/month die in ~8 days under an always-on Oban-polling gateway. | Supabase chosen (no compute-hour meter); decision frozen in ADR-004 so nobody swaps providers casually; daily Oban heartbeat defeats Supabase's 7-day pause; tuned-Neon fallback documented. |
