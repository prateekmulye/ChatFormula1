...
os.environ.setdefault("OPENAI_API_KEY", "dummy_openai_api_key")
os.environ.setdefault("PINECONE_API_KEY", "dummy_pinecone_api_key")
os.environ.setdefault("TAVILY_API_KEY", "dummy_tavily_api_key")
